...
$query = "SELECT *, br.id AS brId, s.id AS sId, s.name AS sName, cn.name AS cnName FROM breeding_records br";
                                ...
                                <?php if (!empty($breedings)) : ?>
                                    ...
                                    foreach ($breedings as $breeding) : ?>
                                        <tr>
                                            ...
                                            <td class="product-table-text"><?php echo $breeding->cnName ?></td>
                                            ...
                                            <td class="icons">
                                                <div class="d-flex">
                                                    <a href="edit-breeding.php?id=<?php echo $breeding->brId ?>"> <i class="bi bi-pencil-square"></i></a>
                                                    <a href="?id=<?php echo $breeding->brId ?>"> <i class="bi bi-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
