                        ...
                        <ul>
                            ...
                            <li class="menu-item">
                                <a href="breeding.php">
                                    ...
                                    <span class="menu-title">Breeding Record</span>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="bull-service.php">
                                    <span class="menu-icon">
                                        <i class="bi bi-node-plus"></i>
                                    </span>
                                    <span class="menu-title">Bull Service</span>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="calf-status.php">
                                    <span class="menu-icon">
                                        <i class="bi bi-card-text"></i>
                                    </span>
                                    <span class="menu-title">Calf Status</span>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="diseases.php">
                            ...
                            <li class="menu-item">
                                <a href="disposal_records.php">
                                    <span class="menu-icon">
                                        <i class="bi bi-x-circle"></i>
                                    </span>
                                    <span class="menu-title">Disposal Records</span>
                                </a>
                            </li>
                        </ul>
                        <div class="menu-item py-3">
