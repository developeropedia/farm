            ...
            <div class="col-lg-12 mt-4 ">
                <div class="panel-card">
                    <form action="" method="post">
                        <div class="row">
                            <div class="col-lg-12">
                                <p class="f-20 w-400 my-2">Add Disposal Record</p>
                                <?php echo $msg ?? "" ?>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input required type="date" name="disposal_date" class="form-control" id="pd">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="mp" class="form-label f-14 w-500">Disposal Reason</label>
                                    <input required type="text" name="disposal_reason" class="form-control" id="mp">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-3">
